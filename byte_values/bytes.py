...
#              "nickname":"Crash on Load"}, # jan_22 ?
    ...
    # dgb_00 missing ?  
    "dgb_01":{"bytes":(0x24020101).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Great Hall"},
    "dgb_02":{"bytes":(0x24020102).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: West Hall (1F)"},
    "dgb_03":{"bytes":(0x24020103).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Table/Clock Room (1/2F)"},
    "dgb_04":{"bytes":(0x24020104).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Stairs to Basement"},
    "dgb_05":{"bytes":(0x24020105).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Stairs Above Basement"},
    "dgb_06":{"bytes":(0x24020106).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Basement"},
    "dgb_07":{"bytes":(0x24020107).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Study (1F)"}, # easy open item
    "dgb_08":{"bytes":(0x24020108).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: East Hall (1/2F)"},
    "dgb_09":{"bytes":(0x24020109).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: West Hall (2F)"},
    "dgb_10":{"bytes":(0x2402010A).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Sealed Room (2F)"},
    "dgb_11":{"bytes":(0x2402010B).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Covered Tables Room (1F)"},
    "dgb_12":{"bytes":(0x2402010C).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Spike Trap Room (2F)"},
    "dgb_13":{"bytes":(0x2402010D).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Hidden Bedroom (2F)"},
    "dgb_14":{"bytes":(0x2402010E).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Stairs to Third Floor"}, # easy boxed item
    "dgb_15":{"bytes":(0x2402010F).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: West Hall (3F)"},
    "dgb_16":{"bytes":(0x24020110).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Sleeping Clubbas Room (3F)"},
    "dgb_17":{"bytes":(0x24020111).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Save Room (3F)"}, # Mario spawns below floor but moves back inbounds
    "dgb_18":{"bytes":(0x24020112).to_bytes(4,"big"),
              "nickname":"Tubba's Castle: Master Bedroom (3F)"},
    "kzn_01":{"bytes":(0x24020113).to_bytes(4,"big"),
              "nickname":"Mt Lavalava: Volcano Entrance"},
    "kzn_02":{"bytes":(0x24020114).to_bytes(4,"big"),
              "nickname":"Mt Lavalava: First Lava Lake"},
}